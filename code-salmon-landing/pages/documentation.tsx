...
export default function Documentation() {
  return (
    ...
    >
      ...
      {/* Legal Pad */}
      <div
        className="relative z-10 pl-8 sm:pl-12 md:pl-20 bg-[#fef3c7] text-gray-900 p-6 sm:p-8 md:p-10 shadow-4xl rounded-md border border-gray-300 w-full max-w-7xl h-auto overflow-hidden font-subheader my-8"
        style={{
          backgroundImage: `repeating-linear-gradient(
            to bottom,
            transparent 0px,
      ...
      >
        {/* Red margin line */}
        <div className="absolute top-0 bottom-0 left-6 sm:left-10 md:left-14 w-[2px] bg-red-400 opacity-60 z-0" />

        {/* Content */}
        <div className="relative z-10">
          <h1
            className="text-2xl sm:text-3xl md:text-4xl font-title mb-4 text-salmon break-words"
            style={{ textShadow: '6px 6px 8px rgb(255, 255, 255)' }}
          >
            Code Salmon Documentation
          </h1>
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-2 text-salmon">What is Code Salmon?</h2>
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-2 text-salmon">Problem Solved</h2>
          <p className="mb-4 text-sm sm:text-base">
            External APIs evolve. When they do, your application might silently break. Code Salmon stops that by:
          </p>
          <ul className="list-disc ml-4 sm:ml-6 mb-4 sm:mb-6 text-sm sm:text-base">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-2 text-salmon">Features</h2>
          <ul className="list-disc ml-4 sm:ml-6 mb-4 sm:mb-6 text-sm sm:text-base">
            <li>Scans <code className="bg-white/60 px-1 rounded">.ts</code> files for <code className="bg-white/60 px-1 rounded">fetch()</code> calls</li>
            <li>Extracts API URLs and environment keys</li>
            <li>Fetches and saves baseline responses in JSON</li>
            <li>Compares future responses to detect structural drift</li>
            <li>Reports drift directly in the terminal</li>
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-2 text-salmon">Configuration Tips</h2>
          <ul className="list-disc ml-4 sm:ml-6 mb-4 sm:mb-6 text-sm sm:text-base">
            <li>Ensure a valid <code className="bg-white/60 px-1 rounded">.env</code> file exists with relevant API keys</li>
            <li>Customize scan targets via <code className="bg-white/60 px-1 rounded">tsconfig.json</code></li>
          </ul>

          <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-2 text-salmon">Installation & Usage</h2>
          <pre className="bg-white/60 p-3 sm:p-4 rounded-lg text-xs sm:text-sm overflow-auto mb-2">
            <code>npm install codesalmon</code>
          </pre>
          <p className="mb-2 text-sm sm:text-base">To generate your initial baseline:</p>
          <pre className="bg-white/60 p-3 sm:p-4 rounded-lg text-xs sm:text-sm overflow-auto mb-2">
            <code>scanSalmon</code>
          </pre>
          <p className="mb-2 text-sm sm:text-base">To check for contract drift later:</p>
          <pre className="bg-white/60 p-3 sm:p-4 rounded-lg text-xs sm:text-sm overflow-auto mb-4 sm:mb-6">
            <code>swimSalmon</code>
          </pre>
          <p className="italic mb-4 sm:mb-6 text-xs sm:text-sm">
            *Pro Tip: For meaningful contract drift, wait days or weeks between scans to observe real API changes.*
          </p>

          <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8 mb-2 text-salmon">Contract Drift Report</h2>
          <p className="mb-4 text-sm sm:text-base">
            When you run <code className="bg-white/60 px-1 rounded">swimSalmon</code>, the CLI outputs a detailed report highlighting any changes to API responses.
          </p>
          <h3 className="text-lg sm:text-xl font-semibold mt-4 mb-2">Possible Report Outputs</h3>
          <ul className="list-disc ml-4 sm:ml-6 mb-2 text-sm sm:text-base">
            <li><strong>Changed at</strong>: Indicates fields with value/type changes</li>
            <li><strong>Addition at</strong>: Shows where new key/value pairs were added</li>
            <li><strong>Removed at</strong>: Flags missing fields from the original baseline</li>
            <li><strong>Unhandled Change Type</strong>: Catches unknown or deeply restructured responses</li>
